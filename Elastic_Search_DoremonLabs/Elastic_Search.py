...
def count_doc_in_time(res,body):
    ...
    print("Total counts in given range of time is--",end=" ")
    print(total_count_of_timestamp)
...
def count_in_response_time(res,body1):
    ...
    print("Total Counts in range of 400<=response_time<=500--",end=" ")
    print(total_count_of_response_time) 
